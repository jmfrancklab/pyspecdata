...
class nddata (nddata_ft):
    ...
    def nnls(self, dimname, newaxis_dict, kernel_func, l=0):
        ...
        l : double (default 0) or str
            ...
            standard nnls.
            If this is set to :str:`BRD`,
            then automatic parameter selection is executed
            according to the BRD algorithm,
            either in 1-dimension or
