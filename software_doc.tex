...
\usepackage{mydefs}%  does this work?
\begin{document}

\pagestyle{plain}
%\title{Employing Compact High-Frequency Sources to Probe Dielectric Response}
%\author{J. Franck}
%\maketitle
%\lhead{J.Franck}
%\fancyhf{}
...
%\par}
%\begin{multicols}{2}
%{{{ the following will turn on the table of contents
%\pagenumbering{roman}
%\tableofcontents
%\newpage
...
%\input{summaries/dna}
%\input{summaries/bio_demo}
%\input{specific/klow_math}
%\input{inprocess/writeup_dna}
%\input{specific/marohn_prop}
%\input{specific/phcyc}
%\begin{python}
%#redo
%data = save_data({
%   'oxotempo_elratio':9.7912/3482.776e-4,
%   'oxotempo_nmrelratio':14.8503632/9.7912});
%calcfield(9.7912,elratio=data['oxotempo_elratio'],nmrelratio=data['oxotempo_nmrelratio'])
%\end{python}
%\input{allratios}
<<<<<<< HEAD
%\input{summaries/intro_to_dnp}
\input{summaries/writeup_software}
%\input{summaries/software/struct_array}
%\input{inprocess/writeup_glaser}
=======
\input{summaries/writeup_software}
%\input{summaries/software/struct_array}
>>>>>>> public
%\input{inprocess/4ohtseries}
%\input{inprocess/4ohtseries/repetition_fresh}
%\input{inprocess/4ohtseries/nice_like_prev}
%\input{inprocess/conc_xi}
%\input{inprocess/hiv_pr}
%\input{inprocess/groes}
%\input{inprocess/groes/new_label}
%\input{inprocess/groes/first_go}
%\input{inprocess/groes/new_label_rerun}
%\input{inprocess/crowding/summary121029}
%\input{summaries/dna}
%\input{summaries/dna-diff}
%\input{specific/example_pseudocode_for_thomas}
%\input{specific/breit_rabi}
%\input{specific/breit_rabi}
