...
plot(true_F/max(true_F.data),label='True')
plot(L_opt_vec/max(L_opt_vec.data),label='L-Curve')
plot(opt_vec/max(opt_vec.data),label='BRD')
plot(solution/max(solution.data),':',label='pyspecdata-BRD')
legend()
show();quit()
