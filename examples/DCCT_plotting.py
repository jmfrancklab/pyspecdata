"""plotting with DCCT plot
==========================

This example creates a fake inversion recovery
data set and plots the data with coherence
transfer pathways in a reasonable way using
DCCT plotting."""
